...
When we move to full public testnet and mainnet we expect to be able to support a wider range of operations. See [Types and Operators](/../writing%20smart%20contracts/types-and-operators) for more information.
