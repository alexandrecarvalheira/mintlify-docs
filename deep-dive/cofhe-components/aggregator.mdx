---
title: Aggregator
description: "Intermediary service between the blockchain and computation layer that manages and organizes events from the Task Manager Contract for efficient processing"
---
