...
import GitPodLogo from '@site/static/images/gitpod-logo.svg';
...
To learn more about the Fhenix Hardhat Plugin, please visit the [Fhenix Hardhat Plugin](/tools%20and%20utilities/fhenix-hardhat-plugin).
