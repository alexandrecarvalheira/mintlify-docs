...
Follow the instructions in the [Fhenix Nitrogen Testnet](/fhenix%20testnet/connecting-to) to add Fhenix to Metamask.
...
See the [Fhenix Remix Plugin](/tools%20and%20utilities/fhenix-remix-plugin) for more information on how to install and use the plugin!
