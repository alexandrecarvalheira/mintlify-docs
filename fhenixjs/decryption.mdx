...
You can read more about how to do this [here](/writing%20smart%20contracts/returning-data).
</Tip>
...
The fhenix.js Javascript library includes methods to support creating parameters for values that require [Permits & Access Control](/encryption%20and%20privacy/permits-access-control). These methods can help creating ephemeral transaction keys, which are used by the smart contract to create a secure encryption channel to the caller.
